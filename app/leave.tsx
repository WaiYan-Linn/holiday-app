...
export default function LeaveScreen() {
  ...
  const longWeekends = [
    { name: 'New Year Break', dates: 'Jan 1 - Jan 4', days: 4, icon: 'sparkles' },
    { name: 'Thingyan Festival', dates: 'Apr 11 - Apr 19', days: 9, icon: 'water' },
    { name: 'Thadingyut Break', dates: 'Oct 25 - Oct 27', days: 3, icon: 'sunny' },
  ];
          ...
          <GlassCard key={index} style={styles.horizontalCard}>
             <View style={styles.cardHeader}>
               <View style={[styles.iconCircle, { backgroundColor: headerColor + '20' }]}>
                 <Ionicons name={item.icon as any} size={30} color={headerColor} />
               </View>
...
const styles = StyleSheet.create({
  ...
  tipBox: { backgroundColor: 'rgba(0,122,255,0.05)', padding: 15, borderRadius: 15 },
